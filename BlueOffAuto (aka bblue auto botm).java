//OK FAMILY, HERE IS THE BIZZ: Nothing is changed except for addition of an abstraction (AP CSP!!) + I removed the code that
//separated the right column movement from the other two column movement
...
@Autonomous(name = "BlueOffAuto")

public class BlueOffAuto extends LinearOpMode {
